...
Lunch and coffee breaks will be provided dail
...
**Prerequisites**: Prerequisite vary from session to session. Some require no prior experience. Others assume material presented in earlier bootcamp sessions. Still others require at least some prior exposure to Linux and/or Python. More information about a session's prerequisites can be found in that session's description on the bootcamp website.  
